...
func main() {
cfg := ingestion.MustLoad("svc-ew-ingestion", "sensors.ew.intercepts", "dlq.sensors.ew", 50052)
...
logger.Info("starting svc-ew-ingestion", zap.Int("port", cfg.GRPCPort))
...
logger.Info("svc-ew-ingestion stopped")
}
