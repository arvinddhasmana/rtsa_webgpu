...
auditEmitter := audit.NewEmitter(prod, "svc-isr-ingestion", logger)
...
meter := tp.MeterProvider.Meter("svc-isr-ingestion")
...
zap.String("service", "svc-isr-ingestion"),
