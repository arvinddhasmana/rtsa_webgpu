...
func main() {
cfg := ingestion.MustLoad("svc-isr-ingestion", "sensors.isr.observations", "dlq.sensors.isr", 50054)
...
logger.Info("starting svc-isr-ingestion", zap.Int("port", cfg.GRPCPort))
...
logger.Info("svc-isr-ingestion stopped")
}
