...
func main() {
cfg := ingestion.MustLoad("svc-ais-ingestion", "sensors.ais.positions", "dlq.sensors.ais", 50055)
...
logger.Info("starting svc-ais-ingestion", zap.Int("port", cfg.GRPCPort))
...
logger.Info("svc-ais-ingestion stopped")
}
