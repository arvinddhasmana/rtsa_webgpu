...
p := producer.NewObservationProducer(nil, "sensors.ais.positions")
if p.Topic() != "sensors.ais.positions" {
t.Errorf("expected topic sensors.ais.positions, got %s", p.Topic())
}
}
