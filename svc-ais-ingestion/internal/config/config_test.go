...
func TestLoad_Coverage(t *testing.T) {
	t.Setenv("RTSA_SERVICE_NAME", "svc-ais-ingestion")
	t.Setenv("RTSA_AIS_RANGE_NM", "100.0")
	t.Setenv("RTSA_AIS_BEARING_START", "0.0")
	t.Setenv("RTSA_AIS_BEARING_END", "180.0")
	t.Setenv("RTSA_AIS_LAT", "45.0")
	t.Setenv("RTSA_AIS_LON", "-60.0")
	...
	if *cfg.Coverage.RangeNm != 100.0 {
		t.Errorf("expected 100.0 range, got %f", *cfg.Coverage.RangeNm)
	}
}

func TestLoad_InvalidCoverage(t *testing.T) {
	t.Setenv("RTSA_SERVICE_NAME", "svc-ais-ingestion")
	t.Setenv("RTSA_AIS_RANGE_NM", "invalid")
	t.Setenv("RTSA_AIS_BEARING_START", "invalid")
	t.Setenv("RTSA_AIS_BEARING_END", "invalid")
	t.Setenv("RTSA_AIS_LAT", "invalid")
	t.Setenv("RTSA_AIS_LON", "invalid")

	cfg, _ := config.Load()
	if cfg.Coverage != nil {
		t.Error("expected nil Coverage for invalid inputs")
	}
}
