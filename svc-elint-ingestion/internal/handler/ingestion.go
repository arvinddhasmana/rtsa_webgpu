...
"github.com/arvinddhasmana/RTSA_VS_Opus/svc-elint-ingestion/internal/producer"
"go.uber.org/zap"
...
// IngestionHandler implements IngestionService for ELINT/COMINT data.
...
// IngestSingleObservation handles unary ELINT observation ingestion.
...
zap.String("sensor_id", obs.GetSensorId()),
zap.String("observation_id", obs.ObservationId),
zap.String("sensor_type", "ELINT/COMINT"),
...
// IngestSensorData handles client-streaming ELINT observation ingestion.
...
// GetSensorStatus returns live statistics for the ELINT ingestion service.
