...
ServiceName:    "svc-elint-ingestion",
...
ClientID:   "svc-elint-ingestion",
}

// 4. Create Redpanda producer (for sensors.elint.detections)
...
auditEmitter := audit.NewEmitter(prod, "svc-elint-ingestion", logger)
...
zap.String("service", "svc-elint-ingestion"),
