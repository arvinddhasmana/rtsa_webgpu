...
> **⚠ WebGPU COP Migration Notice** — UI navigation steps below reflect the _projected_ SolidJS + WebGPU interface. Specific elements may change during implementation. See `docs/architecture/v1/RTSA_WebGPU_Architecture_v1.md`.
...
| **[Assign]**  | Assign to another operator — opens operator picker dialog         | `AlertService.AssignAlert` _(v2.0)_ |
