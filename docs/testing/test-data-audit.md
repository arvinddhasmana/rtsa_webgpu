...
| UC006 — COP Display            | web-cop-gpu vitest (tests/)                                      | —                         | —                   | `map.spec.ts`, `alerts.spec.ts`             | Both          | ✅ Covered             |
| UC007 — Alert Management       | svc-alert tests                                                  | IT08                      | E2E02               | `alerts.spec.ts`                            | Both          | ✅ Covered             |
| UC008 — Track Detail           | web-cop-gpu vitest                                               | —                         | —                   | `detail-panel.spec.ts`                      | Both          | ✅ Covered             |
